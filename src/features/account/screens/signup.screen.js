...
export const SignUpScreen = ({navigation}) => {
    return (
        <AccountContainer>
            <Text style={{ fontSize: 16, color: '#fff', fontWeight:'500' }}>Sign Up</Text>
            ...
            <Text style={{ color: '#ffffff', fontSize: 11, textAlign: 'center', marginTop: 4, padding:4 }}>By signing up, you agree to Cukur In <Text style={{ color: '#9C0A10', fontSize: 11 }}>Terms and Condition</Text> and <Text style={{ color: '#9C0A10', fontSize: 11 }}>Privacy Policy</Text></Text>
